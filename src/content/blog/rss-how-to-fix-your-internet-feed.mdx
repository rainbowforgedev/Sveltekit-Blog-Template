...
![RSS reader screenshot](/content/rss-how-to-fix-your-internet-feed/24.webp)

For demonstration, I added three feeds. [My rss feed](https://bahaazidan.com/rss.xml) included. You can see the reader combining all of the feeds together. It can keep track of what I read. It has "Reader" mode, which basically scraps the website for the entire article content and shows it to me in reader in case the website only puts summary in their feed. I can star articles as a way of bookmarking them. I can do a lot. I'm in control here. I can add 10, 100, or thousands of feeds if I wanted to. And I can do so from across the internet. I'm not tied to one platform.
...
![copy channel id](/content/rss-how-to-fix-your-internet-feed/46.webp)
...
![add url to rss reader](/content/rss-how-to-fix-your-internet-feed/53.webp)
...
![reader after adding fireship](/content/rss-how-to-fix-your-internet-feed/54.webp)
