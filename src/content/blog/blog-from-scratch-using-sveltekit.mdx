...
In addition to Tailwind, I'm using [DaisyUI](https://daisyui.com/components/card/) for styling. But it's up to your preference. You can see this list in action [here](https://bahaazidan.com/).
...
3. `rehype-pretty-code` super charges our code blocks with beautiful and context aware syntax highlighting. I showcased some of its capabilities in a [previous post](https://bahaazidan.com/blog/supercharge-code-blocks-astro-js).
...
Sitemap: https://bahaazidan.com/sitemap.xml
```
...
This blog. Yes, the one you're reading rightnow, is completely open source. You can read the complete code yourself on [GitHub](https://github.com/BahaaZidan/bahaazidan.com). Feel free to fork it or just copy the code into your project if you want. Enjoy ✌️ 🍉
