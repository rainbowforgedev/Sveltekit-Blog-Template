...
I didn't like the Search component that comes built-in. So I created my own using Svelte. You can read the source code [here](https://github.com/BahaaZidan/io.bahaazidan.com/blob/005ffa8eb8996d9e81923b7c62d1a0b48ffcb7e8/src/components/SearchBar.svelte).
