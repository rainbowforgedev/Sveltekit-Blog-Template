...
export async function GET() {
	...
	for (const article of articles) {
		feed.addItem({
			...
			content: `<p>${article.description}</p> <div style="margin-top: 50px; font-style: italic;"> <strong><a href="https://bahaazidan.com${article.path}">Keep reading</a>.</strong> </div> <br /> <br />`,
			link: `https://bahaazidan.com${article.path}`,
			author: [
				{
					name: 'Gebna / Bahaa Zidan',
					email: 'gebnatorky@gmail.com',
